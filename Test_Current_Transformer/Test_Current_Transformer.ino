...
void setup() 
 ...
 void loop()  {   
   ...
   */
   ...
   Therefore current through 200 ohm resistor is multiplied by 1000 to get input current
   */ 
 ...
 /************************************ 
In order to calculate RMS current, we need to know the peak to peak voltage measured at the output across the
200 Ohm Resistor
The following function takes one second worth of samples and returns the peak value that is measured
 *************************************/
